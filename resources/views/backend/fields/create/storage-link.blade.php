<div class="form-group">
    ...
    <div class="input-group">
        ...
        <input id="storage-link" type="text" name="storage_link" class="form-control {{ $errors->has('storage_link') ? 'is-invalid' : '' }}" placeholder="https://" value="{{ old('storage_link') }}">
    ...
    <p id="preview-image-storage-link" class="my-3">
        @if (old('storage_link'))
            <img src="{{ old('storage_link') }}" style="height: 5rem;">
        @endif
    </p>
</div>
